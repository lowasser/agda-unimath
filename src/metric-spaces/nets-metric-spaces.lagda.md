...
product-net-Metric-Space X Y ε (M , approx-M) (N , approx-N) =
  ( product-finitely-enumerable-subtype M N ,
    is-approximation-product-approximation-Metric-Space X Y ε
      ( approximation-net-Metric-Space X ε (M , approx-M))
      ( approximation-net-Metric-Space Y ε (N , approx-N)))
```
